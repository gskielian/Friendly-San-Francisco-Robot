...
// Many thanks to Adafruit for this awesome code and GPS library!

// For Uno R3, 
// 1. connect rx to digital pin 3
// 2. connect tx to digital pin 2
// 3. set baud rate of serial monitor to 115200
